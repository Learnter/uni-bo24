	...
	<view class="shuruknzdBox">
		<form @submit="formSubmit">
			...
			<view class="uni-form-item uni-column qxloninputBox">
				...
				<view class="with-fun qxloninput">
					<input class="uni-input" :placeholder="i18n.verifyCodeHolder" maxlength="4" v-model="transferObj.verify_code" placeholder-style="color:#C4D8D8;" />
...
<script>
    ...
    onLoad() {
      uni.setNavigationBarTitle({
          title:this.$t('navText').hbyTransfer
      })
    },
    onReady(){
      this.fetchGraphCode();
