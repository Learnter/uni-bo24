  ...
  <view>
    <view class="ssordsetlBoxHe">
      <view class="uni-flex ssordsetlBox">
        <view class="fx1 ssordsetl" @click="mobilebtn">{{common.category}}<image src="/static/images/a024laner_83.png" mode="widthFix"
            class="zxia"></image>
        </view>
        <view class="fx1 ssordsetl" @click="pricebtn">{{common.date}}<image src="/static/images/a024laner_83.png" mode="widthFix"
            class="zxia"></image>
        </view>
        <view class="fx1 ssordsetl" @click="amountbtn">{{common.sort}}<image src="/static/images/a024laner_83.png" mode="widthFix"
            class="zxia"></image>
        </view>
      </view>
    </view>
    ...
    <view class="recoeBox">
      <view>
        <view class="tradparLi uni-flex" v-for="(lItem,lIndex) in moneyLogs" :key="lIndex">
<!--          <view class="tradparLiimg">
            <image src="/static/images/logo3.png" mode=""></image>
          </view> -->
          <view class="fx1">
            <view class="tradparLitx">{{lItem.wallet_name}}：{{lItem.type}}</view>
  ...
  export default {
	...
	onLoad() {
	  uni.setNavigationBarTitle({
	  	title:this.$t('navText').financial
	  })
	},
    onReady() {
      this.fetchType();
    ...
    methods: {
      fetchType() { //获取钱包分类
        this.$request.get(this.$KPI.BsnSystem.financeCategory).then(res => {
      ...
      fetchLogs() { //获取钱包日志
        ...
        this.$request.get(this.$KPI.BsnSystem.financeLogs, this.reConfig).then(res => {
          // console.log(res);
