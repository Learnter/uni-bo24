	...
	<view class="shuruknzdBox">
		<form @submit="formSubmit" >		
			<view class="uni-form-item uni-column qxloninputBox">
				<view class="qxloninptl">{{i18n.loginPwd}}：</view>
				<view class="with-fun qxloninput">
					<input type="password" v-model="upData.password" class="uni-input" :placeholder="holder.setPwd" placeholder-style="color:#C4D8D8;" />				
				</view>
			</view>
			<view class="uni-form-item uni-column qxloninputBox">
				<view class="qxloninptl">{{i18n.comfirmPwd}}：</view>
				<view class="with-fun qxloninput">
					<input :password="showPassword" v-model="upData.repassword" class="uni-input" :placeholder="holder.confirmPwd" placeholder-style="color:#C4D8D8;" />			
			...
			<view class="uni-form-item uni-column qxloninputBox">
				...
				<view class="with-fun qxloninput">
					<input class="uni-input" v-model="upData.mobileCode" :placeholder="holder.securityCode" placeholder-style="color:#C4D8D8;" placeholder-class="uni-ellipsis" />
...
<script>
    ...
    onLoad() {
      uni.setNavigationBarTitle({
        title:this.$t('navText').s_loginPwd
      })
    },
		onReady() {
		 this.fetchPhoneNum();
      ...
      formSubmit(){ //修改密码
        // let {password,repassword,mobileCode} = this.upData;
        ...
        //    return false; 
        //  }
      this.$request.post(this.$KPI.alter.upLoginPwd,this.upData).then( res => {
          if(res.code === 200){
            uni.showToast({
              icon:'loading',
